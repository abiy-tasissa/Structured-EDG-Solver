...
%
% Description:
% This script demonstrates the AB_completion.m script. We test it on protein data,
...
m = 30;
% Load protein data. 
protein_data =  pdb2mat("./data/1ax8.pdb");
P = [protein_data.X ;protein_data.Y; protein_data.Z];
p = length(P);
n = p-m;
% Setup anchors
anchors = 1:m:p;
idx_anchors = [anchors setdiff(1:p,anchors)];
P = P(:,idx_anchors);
